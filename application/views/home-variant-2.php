...
<body>
	...
	<div class="hero-unit">
		<p>Simplified template for your homepage .</p> 
	</div>
...
<div class="container">
	...
	<div class="row">
		<div class="span1">
			<span class="circle" style="background:#ED3E3E;"><i class="icon-heart-empty"></i></span>
		</div>
		<div class="span3">
			<br />
		...
		<div class="span1">
			<span class="circle" style="background:#80AD00;"><i class="icon-leaf"></i></span>
		</div>
		<div class="span3">
			<br />
			<h3>Eco-friendly</h3>
		...
		<div class="span1">
			<span class="circle" style="background:#5DB9F2;"><i class="icon-bolt"></i></span>
		</div>
		<div class="span3">
			<br />
