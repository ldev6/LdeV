	...
	<div id="carousel" class="carousel slide macbook" rel="carousel">
		...
		<div class="carousel-inner">
			...
			<div class="item active">
				<img src="http://placehold.it/512x322/A2DEE3/FFF" alt="" />
			</div>
			<!-- end Item -->
			<!-- Item -->
			<div class="item">
				<img src="assets/carousel/a.jpg" alt="" />
			</div>
			<!-- end Item -->
			<!-- Item -->
			<div class="item">
				<img src="assets/carousel/b.jpg" alt="" />
			</div>
			<!-- end Item -->
			<!-- Item -->
			<div class="item">
				<img src="assets/carousel/c.jpg" alt="" />
			</div>
			<!-- end Item -->
			<!-- Item -->
			<div class="item">
				<img src="assets/carousel/e.jpg" alt="" />
			</div>
			<!-- end Item -->
		</div>
		<!-- Carousel navigation -->
...
<section class="container">
	...
	<section class="row">
		...
		<article class="span4">
			<h2><span class="grey">We're</span> in Palo Alto</h2>
...
<div class="services">
	<ul class="nav nav-tabs">
		...
		<li rel="service-3">
			<a href="#service-3" data-toggle="tab">
				<img src="img/icons/stopwatch.png" alt="" />	
			</a>
		</li>
		<li rel="service-4">
	...
	<div class="tab-content">
		<div id="service-1" class="tab-pane active">
			...
			<a class="button orange fr" href="work.html">view our portfolio &rarr;</a>	
			<p>
